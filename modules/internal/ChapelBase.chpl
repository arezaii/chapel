...
module ChapelBase {
  ...
  extern proc chpl_config_has_value(name:c_ptrConst(c_uchar), module_name:c_ptrConst(c_uchar)): bool;
  extern proc chpl_config_get_value(name:c_ptrConst(c_uchar), module_name:c_ptrConst(c_uchar)): c_ptrConst(c_uchar);
